...
const FilterSidebar = ({isOpen,setIsOpen}) => {
  ...
  const toggleSidebar = () => {
    // alert("Hellow");
    console.log('toggleSidebar enter');
  ...
  return (
    <>
      ...
      <div className={`relative z-40 ${isOpen?"flex":"hidden"} lg:hidden`} role="dialog" aria-modal="true">
     
              <div className="fixed bg-black bg-opacity-25" aria-hidden="true"></div>

              <div className="fixed left-6 top-64 z-40 flex">
            
                <div className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-white py-4 pb-12 shadow-xl">
                  <div className="flex items-center justify-between px-4 ">
                    <h2 className="text-lg font-medium text-gray-900">Filters</h2>
                    <div  className="z-50 -mr-2 flex h-10 w-10 items-center justify-center rounded-md bg-white p-2 text-gray-400 shadow-xl" onClick={toggleSidebar}>
                  ...
                  <form className="mt-4 border-t border-gray-200 px-24">
                    ...
                    <div className="border-t border-gray-200 px-4 py-6">
                      ...
                      <div className="pt-6" id="filter-section-mobile-0">
                        <div className="space-y-6">
                          ...
                          <div className="flex items-center">
                            <input id="filter-mobile-color-2" name="color[]" value="blue" type="checkbox" onChange={()=>console.log("")} className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"/>
                    ...
                    <div className="border-t border-gray-200 px-4 py-6">
                      ...
                      <div className="pt-6" id="filter-section-mobile-1">
                        <div className="space-y-6">
                          ...
                          <div className="flex items-center">
                            <input id="filter-mobile-category-2" name="category[]" value="travel" type="checkbox" onChange={()=>console.log("")} className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"/>
                    ...
                    <div className="border-t border-gray-200 px-4 py-6">
                      ...
                      <div className="pt-6" id="filter-section-mobile-2">
                        <div className="space-y-6">
                          ...
                          <div className="flex items-center">
                            <input id="filter-mobile-size-5" name="size[]" value="40l" type="checkbox" onChange={()=>console.log("")} className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"/>
