      ...
      <div className="border-b border-gray-200 py-6">
        <h3 className="-my-3 flow-root">
          ...
          <button type="button" className="flex w-full items-center justify-between bg-white py-3 text-sm text-gray-400 hover:text-gray-500" aria-controls="filter-section-0" aria-expanded="false">
            ...
            <span className="ml-6 flex items-center">
              ...
              <svg className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                <path fillRule="evenodd" d="M4 10a.75.75 0 01.75-.75h10.5a.75.75 0 010 1.5H4.75A.75.75 0 014 10z" clip-rule="evenodd" />
              </svg>
            </span>
          </button>
        </h3>
        ...
        <div className="pt-6" id="filter-section-0">
          <div className="space-y-4">
            ...
            <div className="flex items-center">
              <input id="filter-color-2" name="color[]" value="blue" type="checkbox" onChange={()=>console.log("")} className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"/>
      ...
      <div className="border-b border-gray-200 py-6">
        ...
        <div className="pt-6" id="filter-section-1">
          <div className="space-y-4">
            ...
            <div className="flex items-center">
              <input id="filter-category-2" name="category[]" value="travel" type="checkbox" onChange={()=>console.log("")} className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"/>
      ...
      <div className="border-b border-gray-200 py-6">
        ...
        <div className="pt-6" id="filter-section-2">
          <div className="space-y-4">
            ...
            <div className="flex items-center">
              <input id="filter-size-5" name="size[]" value="40l" type="checkbox" onChange={()=>console.log("")} className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"/>
